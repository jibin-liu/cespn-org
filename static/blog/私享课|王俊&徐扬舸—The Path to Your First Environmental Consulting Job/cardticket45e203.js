...
});define("new_video/player.js",["page/pages/video.css","biz_wap/zepto/zepto.js","biz_wap/zepto/event.js","biz_wap/zepto/touch.js","biz_wap/jsapi/log.js","biz_common/dom/event.js","new_video/player.html.js","biz_wap/utils/device.js","new_video/ctl.js","biz_common/tmpl.js","pages/iframe_communicate.js","a/a_utils.js","biz_common/utils/url/parse.js"],function(e){
"use strict";
function t(){
i();
}
...
function o(){
if(a())for(var e in g._players){
var t=g._players[e];
if(t.hasBeginPlay()&&t.isPlay()){
t.pause4outer(),g.visibilityPausePlayer=t;
break;
}
}else{
var i=g.visibilityPausePlayer;
i&&i.hasBeginPlay()&&!i.isEnd()&&(i.play4outer(),g.visibilityPausePlayer=null);
}
}
e("page/pages/video.css"),e("biz_wap/zepto/zepto.js"),e("biz_wap/zepto/event.js"),
e("biz_wap/zepto/touch.js");
var r=e("biz_wap/jsapi/log.js"),s=e("biz_common/dom/event.js"),d=e("new_video/player.html.js"),u=e("biz_wap/utils/device.js"),l=e("new_video/ctl.js"),_=e("biz_common/tmpl.js"),h=e("pages/iframe_communicate.js"),c=e("a/a_utils.js"),p=e("biz_common/utils/url/parse.js"),g={
_players:{},
visibilityPausePlayer:null
};
try{
g._debug=window.parent.window.location.href.indexOf("&_debug=1")>0?!0:!1;
}catch(f){
g._debug=!1;
}
var v=3e3;
t();
var m=function(e){
g._debug&&console.log(e);
},y=(navigator.userAgent,function(){
return!0;
}()),b=function(){
return!!u.browser.M1;
}(),w=function(e,t){
...
},S=!u.canSupportVideo,j=function(e){
var t=$(e.container);
...
status:"init",
subStatus:"init"
},e._mustHideFullScreen=b,e.display=e.autoHide?"none":"block",e.ad_muted_btn=e.ad_muted_btn||!1;
var a=_.tmpl(d,e);
t.append(a);
...
if(r.setAttribute("origin_src",s),S)return o.find(".js_btn_play").attr("href",s).show(),
...
g._players[this.id]=this;
};
return $.extend(j.prototype,{
...
var o=e["on"+i];
"function"==typeof o&&o.apply(this,t),"BeginPlay"!=i||null!=n.__replaySec&&0!=n.__replaySec||!u.os.ios||(a.currentTime=.1);
}
},
...
a=t.video,null!=t.__replaySec&&(m(t.id+":timeupdate __replaySec"),a.pause(),a.currentTime=t.__replaySec,
...
m("player inner isend:"+t.isEnd()),t.isEnd()&&(t.changeStatus({
status:"end",
subStatus:""
...
t.showLoading(),t.showCover(),a.pause(),a.src=e,a.load(),a.play(),m(t.id+":stalled"));
}
}),e.on("seeked",function(){
t.__onTouch||(t.changeStatus({
status:"loading",
subStatus:"seeked"
}),a.play()),t.__seeking=!1,m("video seeked event");
...
var e=0;
for(var i in g._players)if(g._players.hasOwnProperty(i)&&e++,e>1)break;
...
var i=a.src;
t.showLoading(),t.showCover(),a.pause(),a.src=i,o++,a.load(),a.play(),m(t.id+":waitingHandlerTimer");
}
}
},1e4)),t._trigger("waiting");
}
}),e.off("play playing").on("play playing",function(e){
return t.__forcePause===!0?void m(t.id+":play playing __forcePause return"):(t.changeStatus({
status:"play",
subStatus:e.type
}),setTimeout(function(){
t.adVideoStatus="play";
},10),m(t.id+":play playing"),n.removeClass("switch_on"),n.addClass("switch_off"),
t._hidePlayControllBar(),t.__startCountTime(),void t._trigger("play"));
}),e.off("pause").on("pause",function(){
m(t.id+":video pause event"),t.changeStatus({
status:"pause",
subStatus:""
...
t.hideLoading(),t.__isInFullScreen=!1),m("fullscreenchange state:"+t.__isInFullScreen+"; event type:"+e.type),
h.broadcastMessage({
...
function e(){
if(S)return location.href=i.opt.src,!1;
if(i.changeStatus({
status:"loading",
subStatus:"preload"
}),a){
...
var i=this,n=this.opt,a=n.extinfo,o=this.container,r=(this.video,o.find(".js_video_play_controll"),
o.find(".js_btn_play")),d=o.find(".js_btn_play_aria"),_=o.find(".js_video_poster"),h=o.find(".js_switch"),c=o.find(".js_progress_bar"),p=o.find(".js_controll"),g=(o.find(".js_played_bar"),
o.find(".js_page_video")),f=o.find(".js_full_mask"),v=o.find(".js_video_pause_controll"),m=o.find(".js_full_screen_control"),b=o.find(".js_loading");
s.on(v[0],"tap",".js_btn_pause",function(){
i.play4outer();
});
var w,T,j,C,P=0,B=!1,k=0,F=0,D=i.__getDuration(),M=0,H=1,x=window.user_uin||0,z=0!==x&&Math.floor(x/100)%1e3<H,V=!1,I=0;
g.on("touchstart",function(e){
1==e.targetTouches.length&&i.isPlay()&&(n.blockTouchVideo||(j=w=new Date,C=T={
x:e.targetTouches[0].clientX,
y:e.targetTouches[0].clientY
},M=i.getCurTime(),u.os.android&&e.preventDefault()));
...
if(C.x==T.x&&C.y==T.y&&Math.abs(o-C.y)>=10)return void(B=!1);
var r=t-w,s=a-T.x,d=o-T.y,u=Math.sqrt(Math.pow(s,2)+Math.pow(d,2))+F,l=Math.min(Math.ceil(u/r),6);
k=Math.floor(.1*u+.2*l*l*l)*Math.ceil(D/500),F=0==k?u:0,0>s&&(k=-k);
var _=180*Math.atan2(d,s)/Math.PI;
B||(_>=-30&&30>=_&&++P,(_>=150&&180>=_||_>=-180&&-150>=_)&&--P,(P>=4||-4>=P)&&(5>=u?P=0:(I=Math.max(I,l),
B=!0))),B&&(M+=k,0>M&&(M=0),M>D&&(M=1*D),i.__setForwardBar(M),e.preventDefault(),
e.stopPropagation()),T={
x:a,
y:o
},w=t;
...
if(B){
if(i.play(M),o.find(".js_forward").css("display","none"),z&&((new Image).src="/mp/jsmonitor?idkey=28307_29_1",
!V)){
var t=(new Date,{
x:e.changedTouches[0].clientX,
y:e.changedTouches[0].clientY
}),n=t.x-C.x,a=t.y-C.y,r=parseInt(Math.sqrt(Math.pow(n,2)+Math.pow(a,2))),s=parseInt(180*Math.atan2(a,n)/Math.PI);
...
i.isInFullScreen()&&!y&&(e.preventDefault(),e.stopPropagation());
}),s.tap(g[0],function(e){
e.target===p[0]||p[0].contains(e.target)||i.isEnd()||i.isPause()||B||i._trigger("touchVideo");
}),s.tap(f[0],function(){
...
}),s.tap(m[0],function(e){
return i.isInFullScreen()?y&&i.exitFullScreen():y&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=28307_56_1&r="+Math.random(),
...
(d||u>=.5)&&(this.progressBarSeekData.dragTime=s,m("_pointerMoveHandler set currentTime, dragTime:"+this.progressBarSeekData.dragTime+" currentTime:"+this.video.currentTime),
...
if("play"==e){
if(i.__forcePause=!1,i._trigger("userplay"),h.broadcastMessage({
type:"broadcastPlay",
data:{
id:this.id
}
}),window.parent.originalVideoAdFrames&&0!=window.parent.originalVideoAdFrames.length)for(var r=0;r<window.parent.originalVideoAdFrames.length;r++)window.parent.originalVideoAdFrames[r].contentWindow.postMessage({
action:"pauseAd",
value:""
},"*");
c.postMessage(window.parent,"onVideoPlayV2",{
vid:p.getQuery("vid")
});
}
var s=this.plugins,d=this._blockPlugin[e]||this._blockPlugin.all,u=0;
if(d&&"function"==typeof d.recv&&(u|=d.recv(e,t),1&u))return!1;
for(var r=0,l=s.length;l>r&&(u|=s[r].recv(e,t),!(2&u));++r);
...
var a="player statusChange, preStatus:"+i+"; status:"+t.status+"; preSubStatus:"+n+"; subStatus:"+t.subStatus;
this._jsapiLog(a),m(a),h.broadcastMessage({
type:"statusChange",
data:{
id:this.id,
preStatus:i,
...
try{
delete g._players[this.id];
}catch(e){}
g.visibilityPausePlayer===this&&(g.visibilityPausePlayer=null);
}
}),j._getFormatTime=T,j;
